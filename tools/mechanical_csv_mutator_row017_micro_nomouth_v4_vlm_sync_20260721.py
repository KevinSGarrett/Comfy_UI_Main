#!/usr/bin/env python3
"""LOCAL PRIMARY CSV mutator: sync TRK/ITEM-W64-017 Notes for micro_nomouth_v4 VLM tip."""
...
PRODUCER_STAMP = "20260720T232950-0500"
VLM_STAMP = "20260720T232956-0500"
...
def build_notes(prove: list[str], output_sha: str, mouth_freeze: float) -> str:
    return (
        ...
        f"vlm_ok ({prove[0]}/{prove[1]}/{VLM_STAMP}); mouth freeze ~0.001 "
...
def main() -> None:
    ...
    if already_synced(notes, prove):
        print("tip", tip)
        print("no-op: TRK/ITEM-W64-017 micro_nomouth_v4 tip Notes already synced")
    ...
    ledger_vocab = {
        "note": (
            f"Mechanical CSV mutator Row017 micro_nomouth_v4 tip sync from {','.join(prove)}; "
    ...
    item_report["notes"] = (
        f"RunPod micro_nomouth_v4 producer+VLM climb {PRODUCER_STAMP}/{VLM_STAMP}: "
    ...
    print("tip", tip)
    print("synced TRK/ITEM-W64-017 micro_nomouth_v4 tip GLOBAL_REVIEW+VLM Notes (2c109f3f/43595464)")
    print("Row074 untouched")
