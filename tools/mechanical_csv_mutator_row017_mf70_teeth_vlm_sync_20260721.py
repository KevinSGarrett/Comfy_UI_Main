#!/usr/bin/env python3
"""LOCAL PRIMARY CSV mutator: sync TRK/ITEM-W64-017 Notes for mf70_teeth VLM tip."""
...
ROW017_EMISSION = (
    f"{EVID}/TRK-W64-017_RUNPOD_FUTURE_PRODUCER_EMISSION_PACKET_20260721T045222-0500.json"
)
ROW017_CLIMB = f"{EVID}/ROW017_RUNPOD_FUTURE_PRODUCER_EMISSION_CLIMB_20260721T045222-0500.json"
ROW017_VLM_DEEPEN = f"{EVID}/ROW017_RUNPOD_MF70_TEETH_VLM_DEEPEN_20260721T045325-0500.json"
ROW017_VLM_OBS = f"{EVID}/TRK-W64-017_RUNPOD_MF70_TEETH_VLM_OBSERVATION_20260721T045325-0500.json"
ROW017_GLOBAL_REVIEW = (
    "Plan/Instructions/QA/Evidence/Image_Artifact_QA/Row017_Canonical_Global_Reviews/"
    "ROW017_RUNPOD_MF70_TEETH_20260721T045222-0500_GLOBAL_REVIEW.json"
)
ROW017_VISUAL_QA = (
    "Plan/Instructions/QA/Evidence/Image_Artifact_QA/"
    "ROW017_RUNPOD_MF70_TEETH_VISUAL_QA_20260721T045222-0500.json"
)
...
SYNC_MARKER = "synced_by_primary_csv_mutator_row017_mf70_teeth_vlm"
PRODUCER_STAMP = "20260721T045222-0500"
VLM_STAMP = "20260721T045325-0500"
REGION = "mf70_teeth"
PROMPT_ID = "9ff09e1c-3bc8-40a8-b1c3-a299d1060070"
NEXT_ACTION = (
    "Keep Row017 blocked/non-complete; prepared primary localized lane set exhausted after "
    "mf70_teeth — prefer Row010 face-tighter personal-calib re-VLM or product-campaign "
    "acceptance path; leave Row074 alone; no HOLD 090+; no COMPLETE."
)
...
def main() -> None:
    ...
    for rel in (
        ROW017_VLM_DEEPEN,
        f"Plan/Tracker/Evidence/ROW017_RUNPOD_MF70_TEETH_VLM_DEEPEN_{VLM_STAMP}.json",
        ROW017_VLM_OBS,
        f"Plan/Tracker/Evidence/TRK-W64-017_RUNPOD_MF70_TEETH_VLM_OBSERVATION_{VLM_STAMP}.json",
        ROW017_EMISSION,
    ...
    deepen["evidence_id"] = f"ROW017-RUNPOD-MF70-TEETH-VLM-DEEPEN-{VLM_STAMP}"
