#!/usr/bin/env python3
"""LOCAL PRIMARY CSV mutator: sync TRK/ITEM-W64-017 Notes for mf70_eyelashes VLM tip."""
...
ROW017_EMISSION = (
    f"{EVID}/TRK-W64-017_RUNPOD_FUTURE_PRODUCER_EMISSION_PACKET_20260721T035031-0500.json"
)
ROW017_CLIMB = f"{EVID}/ROW017_RUNPOD_FUTURE_PRODUCER_EMISSION_CLIMB_20260721T035031-0500.json"
ROW017_VLM_DEEPEN = (
    f"{EVID}/ROW017_RUNPOD_MF70_EYELASHES_VLM_DEEPEN_20260721T035040-0500.json"
)
ROW017_VLM_OBS = (
    f"{EVID}/TRK-W64-017_RUNPOD_MF70_EYELASHES_VLM_OBSERVATION_20260721T035040-0500.json"
)
ROW017_GLOBAL_REVIEW = (
    "Plan/Instructions/QA/Evidence/Image_Artifact_QA/Row017_Canonical_Global_Reviews/"
    "ROW017_RUNPOD_MF70_EYELASHES_20260721T035031-0500_GLOBAL_REVIEW.json"
)
ROW017_VISUAL_QA = (
    "Plan/Instructions/QA/Evidence/Image_Artifact_QA/"
    "ROW017_RUNPOD_MF70_EYELASHES_VISUAL_QA_20260721T035031-0500.json"
)
...
SYNC_MARKER = "synced_by_primary_csv_mutator_row017_mf70_eyelashes_vlm"
PRODUCER_STAMP = "20260721T035031-0500"
VLM_STAMP = "20260721T035040-0500"
REGION = "mf70_eyelashes"
PROMPT_ID = "29523e9a-c3a3-4d43-aced-30a991753d3e"
...
def main() -> None:
    ...
    for rel in (
        ROW017_VLM_DEEPEN,
        f"Plan/Tracker/Evidence/ROW017_RUNPOD_MF70_EYELASHES_VLM_DEEPEN_{VLM_STAMP}.json",
        ROW017_VLM_OBS,
        f"Plan/Tracker/Evidence/TRK-W64-017_RUNPOD_MF70_EYELASHES_VLM_OBSERVATION_{VLM_STAMP}.json",
        ROW017_EMISSION,
    ...
    next_action = (
        ...
        "(e.g. eyebrows or next unused prepared localized lane) when queue idle, or "
