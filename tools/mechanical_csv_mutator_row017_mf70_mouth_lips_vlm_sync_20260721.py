#!/usr/bin/env python3
"""LOCAL PRIMARY CSV mutator: sync TRK/ITEM-W64-017 Notes for mf70_mouth_lips VLM tip."""
...
ROW017_EMISSION = (
    f"{EVID}/TRK-W64-017_RUNPOD_FUTURE_PRODUCER_EMISSION_PACKET_20260721T043748-0500.json"
)
ROW017_CLIMB = f"{EVID}/ROW017_RUNPOD_FUTURE_PRODUCER_EMISSION_CLIMB_20260721T043748-0500.json"
ROW017_VLM_DEEPEN = f"{EVID}/ROW017_RUNPOD_MF70_MOUTH_LIPS_VLM_DEEPEN_20260721T044545-0500.json"
ROW017_VLM_OBS = f"{EVID}/TRK-W64-017_RUNPOD_MF70_MOUTH_LIPS_VLM_OBSERVATION_20260721T044545-0500.json"
ROW017_GLOBAL_REVIEW = (
    "Plan/Instructions/QA/Evidence/Image_Artifact_QA/Row017_Canonical_Global_Reviews/"
    "ROW017_RUNPOD_MF70_MOUTH_LIPS_20260721T043748-0500_GLOBAL_REVIEW.json"
)
ROW017_VISUAL_QA = (
    "Plan/Instructions/QA/Evidence/Image_Artifact_QA/"
    "ROW017_RUNPOD_MF70_MOUTH_LIPS_VISUAL_QA_20260721T043748-0500.json"
)
...
SYNC_MARKER = "synced_by_primary_csv_mutator_row017_mf70_mouth_lips_vlm"
PRODUCER_STAMP = "20260721T043748-0500"
VLM_STAMP = "20260721T044545-0500"
REGION = "mf70_mouth_lips"
PROMPT_ID = "7099f147-aabb-4beb-9f7f-985a1c412328"
NEXT_ACTION = (
    "Keep Row017 blocked/non-complete; prefer next unused prepared localized lane "
    "(e.g. mf70_teeth / mf70_forehead_skin) when queue idle, or Row010 face-tighter personal-calib "
...
def main() -> None:
    ...
    for rel in (
        ROW017_VLM_DEEPEN,
        f"Plan/Tracker/Evidence/ROW017_RUNPOD_MF70_MOUTH_LIPS_VLM_DEEPEN_{VLM_STAMP}.json",
        ROW017_VLM_OBS,
        f"Plan/Tracker/Evidence/TRK-W64-017_RUNPOD_MF70_MOUTH_LIPS_VLM_OBSERVATION_{VLM_STAMP}.json",
        ROW017_EMISSION,
    ...
    deepen["evidence_id"] = f"ROW017-RUNPOD-MF70-MOUTH-LIPS-VLM-DEEPEN-{VLM_STAMP}"
