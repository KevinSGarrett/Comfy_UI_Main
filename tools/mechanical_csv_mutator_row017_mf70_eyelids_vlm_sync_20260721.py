#!/usr/bin/env python3
"""LOCAL PRIMARY CSV mutator: sync TRK/ITEM-W64-017 Notes for mf70_eyelids VLM tip."""
...
ROW017_EMISSION = (
    f"{EVID}/TRK-W64-017_RUNPOD_FUTURE_PRODUCER_EMISSION_PACKET_20260721T034108-0500.json"
)
ROW017_CLIMB = f"{EVID}/ROW017_RUNPOD_FUTURE_PRODUCER_EMISSION_CLIMB_20260721T034108-0500.json"
ROW017_VLM_DEEPEN = (
    f"{EVID}/ROW017_RUNPOD_MF70_EYELIDS_VLM_DEEPEN_20260721T034120-0500.json"
)
ROW017_VLM_OBS = (
    f"{EVID}/TRK-W64-017_RUNPOD_MF70_EYELIDS_VLM_OBSERVATION_20260721T034120-0500.json"
)
ROW017_GLOBAL_REVIEW = (
    "Plan/Instructions/QA/Evidence/Image_Artifact_QA/Row017_Canonical_Global_Reviews/"
    "ROW017_RUNPOD_MF70_EYELIDS_20260721T034108-0500_GLOBAL_REVIEW.json"
)
ROW017_VISUAL_QA = (
    "Plan/Instructions/QA/Evidence/Image_Artifact_QA/"
    "ROW017_RUNPOD_MF70_EYELIDS_VISUAL_QA_20260721T034108-0500.json"
)
...
SYNC_MARKER = "synced_by_primary_csv_mutator_row017_mf70_eyelids_vlm"
PRODUCER_STAMP = "20260721T034108-0500"
VLM_STAMP = "20260721T034120-0500"
REGION = "mf70_eyelids"
PROMPT_ID = "058ae809-ce05-4a9a-b7da-36d570cbb772"
...
def main() -> None:
    ...
    for rel in (
        ROW017_VLM_DEEPEN,
        f"Plan/Tracker/Evidence/ROW017_RUNPOD_MF70_EYELIDS_VLM_DEEPEN_{VLM_STAMP}.json",
        ROW017_VLM_OBS,
        f"Plan/Tracker/Evidence/TRK-W64-017_RUNPOD_MF70_EYELIDS_VLM_OBSERVATION_{VLM_STAMP}.json",
        ROW017_EMISSION,
    ...
    next_action = (
        ...
        "(e.g. eyelashes or next unused prepared localized lane) when queue idle, or "
