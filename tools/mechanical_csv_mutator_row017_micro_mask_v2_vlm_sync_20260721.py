#!/usr/bin/env python3
"""LOCAL PRIMARY CSV mutator: sync TRK/ITEM-W64-017 Notes for micro_mask_v2 VLM tip."""
...
ROW017_EMISSION = (
    f"{EVID}/TRK-W64-017_RUNPOD_FUTURE_PRODUCER_EMISSION_PACKET_20260720T233704-0500.json"
)
...
SYNC_MARKER = "synced_by_primary_csv_mutator_row017_micro_mask_v2_vlm"
PRODUCER_STAMP = "20260720T233704-0500"
VLM_STAMP = "20260720T233740-0500"
...
def build_notes(prove: list[str], output_sha: str, face_mean: float) -> str:
    return (
...
def already_synced(notes: str, prove: list[str]) -> bool:
    return (
        "micro_mask_v2 future-producer GLOBAL_REVIEW pass" in notes
...
def main() -> None:
    ...
    if already_synced(notes, prove):
        print("tip", tip)
        print("no-op: TRK/ITEM-W64-017 micro_mask_v2 tip Notes already synced")
    ...
    row017_notes = build_notes(prove, output_sha, face_mean)
    ...
    ledger_vocab = {
        "note": (
            f"Mechanical CSV mutator Row017 micro_mask_v2 tip sync from {','.join(prove)}; "
    ...
    for rel in (
        ROW017_VLM_DEEPEN,
        "Plan/Tracker/Evidence/ROW017_RUNPOD_MICRO_MASK_V2_VLM_DEEPEN_20260720T233740-0500.json",
        ROW017_VLM_OBS,
        "Plan/Tracker/Evidence/TRK-W64-017_RUNPOD_MICRO_MASK_V2_VLM_OBSERVATION_20260720T233740-0500.json",
        ROW017_EMISSION,
        "Plan/Tracker/Evidence/TRK-W64-017_RUNPOD_FUTURE_PRODUCER_EMISSION_PACKET_20260720T233704-0500.json",
        ROW017_CLIMB,
        "Plan/Tracker/Evidence/ROW017_RUNPOD_FUTURE_PRODUCER_EMISSION_CLIMB_20260720T233704-0500.json",
    ):
        stamp(rel)
    ...
    item_report["notes"] = (
        f"RunPod micro_mask_v2 producer+VLM climb {PRODUCER_STAMP}/{VLM_STAMP}: "
    ...
    print("tip", tip)
    print("synced TRK/ITEM-W64-017 micro_mask_v2 tip GLOBAL_REVIEW+VLM Notes")
    print("Row074 untouched")
