#!/usr/bin/env python3
"""LOCAL PRIMARY CSV mutator: sync TRK/ITEM-W64-017 Notes for mf70_eyebrows VLM tip."""
...
ROW017_EMISSION = (
    f"{EVID}/TRK-W64-017_RUNPOD_FUTURE_PRODUCER_EMISSION_PACKET_20260721T035854-0500.json"
)
ROW017_CLIMB = f"{EVID}/ROW017_RUNPOD_FUTURE_PRODUCER_EMISSION_CLIMB_20260721T035854-0500.json"
ROW017_VLM_DEEPEN = (
    f"{EVID}/ROW017_RUNPOD_MF70_EYEBROWS_VLM_DEEPEN_20260721T035859-0500.json"
)
ROW017_VLM_OBS = (
    f"{EVID}/TRK-W64-017_RUNPOD_MF70_EYEBROWS_VLM_OBSERVATION_20260721T035859-0500.json"
)
ROW017_GLOBAL_REVIEW = (
    "Plan/Instructions/QA/Evidence/Image_Artifact_QA/Row017_Canonical_Global_Reviews/"
    "ROW017_RUNPOD_MF70_EYEBROWS_20260721T035854-0500_GLOBAL_REVIEW.json"
)
ROW017_VISUAL_QA = (
    "Plan/Instructions/QA/Evidence/Image_Artifact_QA/"
    "ROW017_RUNPOD_MF70_EYEBROWS_VISUAL_QA_20260721T035854-0500.json"
)
...
SYNC_MARKER = "synced_by_primary_csv_mutator_row017_mf70_eyebrows_vlm"
PRODUCER_STAMP = "20260721T035854-0500"
VLM_STAMP = "20260721T035859-0500"
REGION = "mf70_eyebrows"
PROMPT_ID = "3ee17ab8-24ae-4037-8dd6-1cd36a4a7b44"
...
def main() -> None:
    ...
    for rel in (
        ROW017_VLM_DEEPEN,
        f"Plan/Tracker/Evidence/ROW017_RUNPOD_MF70_EYEBROWS_VLM_DEEPEN_{VLM_STAMP}.json",
        ROW017_VLM_OBS,
        f"Plan/Tracker/Evidence/TRK-W64-017_RUNPOD_MF70_EYEBROWS_VLM_OBSERVATION_{VLM_STAMP}.json",
        ROW017_EMISSION,
    ...
    next_action = (
        ...
        "(e.g. mf70_pupils_iris_sclera / mf70_nose / mf70_mouth_lips) when queue idle, or "
