...
- `ISSUE-AWS-AUTH-EXPIRED-001`: The AWS CLI default login credential expired during workflow lane static proof. EC2 was stopped and verified stopped, but object-info, model path, model hash, execution output, and generated artifact QA are pending until AWS login is refreshed. Latest auth-gate evidence shows `aws login --remote` requires browser authorization that this non-interactive shell cannot complete; EC2 start remains disallowed until account `029530099913` is verified. Evidence: `Plan/Instructions/QA/Evidence/Workflow_Prerequisite_Matching/W61_WORKFLOW_LANE_SELECTION_20260706T024025-0500.json`; `Plan/Instructions/QA/Evidence/Runtime_Readiness/W60_W61_AWS_AUTH_GATE_20260706T031007-0500.json`.
