...
bindings and queue hash `e84670f9...`; no runtime or quality authority follows
...
official identity/license dependency, next `qwen2.5:7b-instruct`; never fall back to AWS.
