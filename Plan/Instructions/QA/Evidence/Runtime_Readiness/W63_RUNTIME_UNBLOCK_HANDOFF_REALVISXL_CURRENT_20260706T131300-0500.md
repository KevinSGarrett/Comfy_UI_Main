...
- created_at: 2026-07-06T13:07:46-05:00
- result: handoff_ready_for_ec2_static_proof
- failure_category: missing_ec2_static_proof
- next_required_action: run_ec2_static_proof
...
- Lane readiness: ready_for_ec2_static_proof, lane_id=sdxl_realvisxl_base_lane, lane_match=True, local_pre_ec2_ready=True, ready_for_ec2_static_proof=True, ready_for_generation=False
- Project readiness: pass_local_ready_for_ec2_static_proof, lane_id=sdxl_realvisxl_base_lane, lane_match=True, local_ready=True, ec2_start_allowed=True, generation_allowed=False, scan_hit_count=0
...
```powershell
powershell -ExecutionPolicy Bypass -File C:\Comfy_UI_Main\Plan\Instructions\Operations\Scripts\Invoke-EC2LaneStaticProof.ps1 -LaneId sdxl_realvisxl_base_lane -Execute -OutFile C:\Comfy_UI_Main\Plan\Instructions\QA\Evidence\Workflow_Static_Validation\W61_EC2_LANE_STATIC_PROOF_<timestamp>.json
```
...
```powershell
powershell -ExecutionPolicy Bypass -File C:\Comfy_UI_Main\Plan\Instructions\Operations\Scripts\Invoke-EC2WorkflowSmokeRun.ps1 -LaneId sdxl_realvisxl_base_lane -Execute -StaticProofFile C:\Comfy_UI_Main\Plan\Instructions\QA\Evidence\Workflow_Static_Validation\W61_EC2_LANE_STATIC_PROOF_<timestamp>.json -ReadinessFile C:\Comfy_UI_Main\Plan\Instructions\QA\Evidence\Runtime_Readiness\W61_LANE_RUNTIME_READINESS_<timestamp>.json -OutFile C:\Comfy_UI_Main\Plan\Instructions\QA\Evidence\Workflow_Runtime\W61_EC2_WORKFLOW_SMOKE_RUN_EXECUTION_<timestamp>.json
```

Expected evidence: Bounded prompt execution, LaneId-matched static proof/readiness, remote artifact manifest, pullback route, and EC2 stop verification.
