# Wave83 Sculpt Material And Surface Detail Map Pipeline Scope
...
1. `C:\Comfy_UI_Main\Plan\07_IMPLEMENTATION\physics_deformation_system\WAVE83_SCULPT_MATERIAL_SURFACE_DETAIL_MAP_PIPELINE.md`
2. `C:\Comfy_UI_Main\Plan\07_IMPLEMENTATION\physics_deformation_system\WAVE83_SCULPT_MATERIAL_SURFACE_DETAIL_MAP_PIPELINE_MATRIX.csv`
3. `C:\Comfy_UI_Main\Plan\Items\wave83_sculpt_material_surface_detail_map_pipeline_itemized_list.csv`
4. `C:\Comfy_UI_Main\Plan\Tracker\wave83_sculpt_material_surface_detail_map_pipeline_tracker.csv`
