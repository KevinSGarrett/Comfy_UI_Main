# Wave82 DAZ Neutral Prototype To Production Mesh Detail Transfer Scope
...
1. `C:\Comfy_UI_Main\Plan\07_IMPLEMENTATION\physics_deformation_system\WAVE82_DAZ_NEUTRAL_PROTOTYPE_TO_PRODUCTION_MESH_DETAIL_TRANSFER.md`
2. `C:\Comfy_UI_Main\Plan\07_IMPLEMENTATION\physics_deformation_system\WAVE82_DAZ_NEUTRAL_PROTOTYPE_TO_PRODUCTION_MESH_DETAIL_TRANSFER_MATRIX.csv`
3. `C:\Comfy_UI_Main\Plan\Items\wave82_daz_neutral_prototype_to_production_mesh_detail_transfer_itemized_list.csv`
4. `C:\Comfy_UI_Main\Plan\Tracker\wave82_daz_neutral_prototype_to_production_mesh_detail_transfer_tracker.csv`
