# Wave79 Body Composition Tissue Material Inference Solver Scope
...
1. `C:\Comfy_UI_Main\Plan\07_IMPLEMENTATION\physics_deformation_system\WAVE79_BODY_COMPOSITION_TISSUE_MATERIAL_INFERENCE_SOLVER.md`
2. `C:\Comfy_UI_Main\Plan\07_IMPLEMENTATION\physics_deformation_system\WAVE79_BODY_COMPOSITION_TISSUE_MATERIAL_INFERENCE_SOLVER_MATRIX.csv`
3. `C:\Comfy_UI_Main\Plan\Items\wave79_body_composition_tissue_material_inference_solver_itemized_list.csv`
4. `C:\Comfy_UI_Main\Plan\Tracker\wave79_body_composition_tissue_material_inference_solver_tracker.csv`
