# Wave81 Support Surface Physics Contact Compression And Deformation Scope
...
1. `C:\Comfy_UI_Main\Plan\07_IMPLEMENTATION\physics_deformation_system\WAVE81_SUPPORT_SURFACE_PHYSICS_CONTACT_COMPRESSION_DEFORMATION.md`
2. `C:\Comfy_UI_Main\Plan\07_IMPLEMENTATION\physics_deformation_system\WAVE81_SUPPORT_SURFACE_PHYSICS_CONTACT_COMPRESSION_DEFORMATION_MATRIX.csv`
3. `C:\Comfy_UI_Main\Plan\Items\wave81_support_surface_physics_contact_compression_deformation_itemized_list.csv`
4. `C:\Comfy_UI_Main\Plan\Tracker\wave81_support_surface_physics_contact_compression_deformation_tracker.csv`
