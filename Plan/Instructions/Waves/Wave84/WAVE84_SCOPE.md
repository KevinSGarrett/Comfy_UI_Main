# Wave84 Animation Mocap And Temporal Physics Pipeline Scope
...
1. `C:\Comfy_UI_Main\Plan\07_IMPLEMENTATION\physics_deformation_system\WAVE84_ANIMATION_MOCAP_TEMPORAL_PHYSICS_PIPELINE.md`
2. `C:\Comfy_UI_Main\Plan\07_IMPLEMENTATION\physics_deformation_system\WAVE84_ANIMATION_MOCAP_TEMPORAL_PHYSICS_PIPELINE_MATRIX.csv`
3. `C:\Comfy_UI_Main\Plan\Items\wave84_animation_mocap_temporal_physics_pipeline_itemized_list.csv`
4. `C:\Comfy_UI_Main\Plan\Tracker\wave84_animation_mocap_temporal_physics_pipeline_tracker.csv`
