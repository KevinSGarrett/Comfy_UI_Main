...
- Threshold authority still frozen synthetic-only.
- Library frame/sample benchmark strata still absent.
- Row072 not COMPLETE.

## Exact Next Action

1. Calibrate representative library onset strata with truth anchors and unfreeze threshold authority, or continue an independent unblocked lane.
