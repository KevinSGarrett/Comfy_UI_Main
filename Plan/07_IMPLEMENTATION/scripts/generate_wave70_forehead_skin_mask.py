...
RUN_STAMP = "20260707T153000-0500"
MASK_TYPE_ID = "mf70_forehead_skin"
TRACKER_ID = "TRK-W70-0004"
ITEM_ID = "ITEM-W70-0004"
CONTRACT_ID = "mask_contract_wave70_mf70_forehead_skin"
SCENE_ID = "scene_wave70_canny_v3_forehead_skin"
MASK_ID = "scene_wave70_canny_v3__person_001__mf70_forehead_skin__minor"
...
def forehead_polygon(width: int, height: int) -> list[tuple[int, int]]:
    points = [
        (0.460, 0.272),
        (0.560, 0.260),
        (0.615, 0.308),
...
def make_mask(source: Image.Image) -> Image.Image:
    ...
    draw.polygon(forehead_polygon(width, height), fill=255)
...
def make_overlay(source: Image.Image, mask: Image.Image) -> Image.Image:
    ...
    polygon = forehead_polygon(*rgba.size)
...
def main() -> int:
    ...
    package_dir = root / "runtime_artifacts" / "mask_factory" / "wave70_mf70_forehead_skin"
    prepared_dir = root / "Plan" / "Instructions" / "Operations" / "Prepared_Input_Assets" / f"wave70_mf70_forehead_skin_{RUN_STAMP}"
    qa_path = root / "Plan" / "Instructions" / "QA" / "Evidence" / "Mask_Factory" / "Wave70" / "mf70_forehead_skin.json"
    tracker_path = root / "Plan" / "Tracker" / "Evidence" / f"W70_MF70_FOREHEAD_SKIN_LOCAL_MASK_SUPPORT_{RUN_STAMP}.json"
    input_copy = root / "ComfyUI" / "input" / "wave70_mf70_forehead_skin_mask.png"
    ...
    mask_path = prepared_dir / "wave70_mf70_forehead_skin_mask.png"
    overlay_path = prepared_dir / "wave70_mf70_forehead_skin_overlay.png"
    mask.save(mask_path)
    ...
    request = {
        "request_id": "wave70_mf70_forehead_skin_local_support",
        ...
        writer.writerow(
            {
                ...
                "pass_id": "wave70_mf70_forehead_skin_local_support",
                "output_prefix": "codex_wave70_mf70_forehead_skin",
            }
        )
    ...
    quality_report = {
        ...
        "protected_neighbor_check": {
            ...
            "protected_regions": ["eyebrows", "hairline", "eyes", "background"],
            "notes": [
                "Mask covers the visible central forehead skin band.",
                "Mask intentionally stays above eyebrows and eyes and below the visible hairline mass.",
    ...
    runtime_evidence = {
        "schema_version": "1.0",
        "evidence_id": f"W70-MF70-FOREHEAD-SKIN-RUNTIME-EVIDENCE-{RUN_STAMP}",
        "timestamp": "2026-07-07T15:30:00-05:00",
    ...
    qa_evidence = {
        "schema_version": "1.0",
        "evidence_id": f"W70-MF70-FOREHEAD-SKIN-LOCAL-SUPPORT-{RUN_STAMP}",
        "timestamp": "2026-07-07T15:30:00-05:00",
        "project_root": str(root),
        ...
        "result": RESULT,
        "boundary": "This proves local Wave70 mf70_forehead_skin mask artifact, overlay, quality score, and workflow routing support only. It does not mark the item complete because generated-output proof and target-runtime proof remain required.",
    }
    write_json(qa_path, qa_evidence)

    tracker_evidence = {
        "schema_version": "1.0",
        "tracker_evidence_id": f"W70_MF70_FOREHEAD_SKIN_LOCAL_MASK_SUPPORT_{RUN_STAMP}",
        ...
        "actual_work_performed": [
            "Generated deterministic local forehead-skin mask PNG.",
