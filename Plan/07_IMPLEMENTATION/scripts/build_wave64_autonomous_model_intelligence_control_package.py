...
def build_schemas() -> dict[str, dict[str, Any]]:
    ...
    schemas["canonical_media_clock_span.schema.json"] = record_schema(
        ...
        [
            ...
            "start_pts", "end_pts_exclusive",
            "start_frame", "end_frame_exclusive", "start_sample", "end_sample_exclusive",
...
def build_item_rows() -> list[dict[str, Any]]:
    ...
    for row in ROWS:
        ...
        rows.append({
            ...
            "Citation_Full_Path": str((ROOT / AUTHORITY_REL).resolve()),
