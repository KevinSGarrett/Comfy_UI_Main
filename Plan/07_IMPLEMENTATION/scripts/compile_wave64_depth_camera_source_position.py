...
def run_ci_fixture_ledger_gate(*, fixture_dir: Path | None = None) -> dict[str, Any]:
    ...
    refuses calibrated trajectory benchmark pass, visual-review, Rows084/085
    acceptance, and row completion claims.
    """
    directory = fixture_dir if fixture_dir is not None else DEFAULT_FIXTURE_DIR
    rebuilt = build_synthetic_camera_listener_source_trajectory_ledger(fixture_dir=directory)
    ...
    return {
        "status": "ok",
        "gate": "row088_ci_fixture_ledger_gate",
...
def main(argv: list[str] | None = None) -> int:
    ...
    parser.add_argument(
        ...
        help=(
            ...
            "calibrated trajectory benchmark pass, visual review, or Rows084/085 "
            "acceptance"
        ),
    )
    parser.add_argument(
