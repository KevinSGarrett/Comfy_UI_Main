...
RUN_STAMP = "20260707T145500-0500"
MASK_TYPE_ID = "mf70_face_full_instance"
TRACKER_ID = "TRK-W70-0001"
ITEM_ID = "ITEM-W70-0001"
CONTRACT_ID = "mask_contract_wave70_mf70_face_full_instance"
SCENE_ID = "scene_wave70_canny_v3_face_full_instance"
MASK_ID = "scene_wave70_canny_v3__person_001__mf70_face_full_instance__minor"
...
def main() -> int:
    ...
    package_dir = root / "runtime_artifacts" / "mask_factory" / "wave70_mf70_face_full_instance"
    prepared_dir = root / "Plan" / "Instructions" / "Operations" / "Prepared_Input_Assets" / f"wave70_mf70_face_full_instance_{RUN_STAMP}"
    qa_path = root / "Plan" / "Instructions" / "QA" / "Evidence" / "Mask_Factory" / "Wave70" / "mf70_face_full_instance.json"
    tracker_path = root / "Plan" / "Tracker" / "Evidence" / f"W70_MF70_FACE_FULL_INSTANCE_LOCAL_MASK_SUPPORT_{RUN_STAMP}.json"
    input_copy = root / "ComfyUI" / "input" / "wave70_mf70_face_full_instance_mask.png"
    ...
    mask_path = prepared_dir / "wave70_mf70_face_full_instance_mask.png"
    overlay_path = prepared_dir / "wave70_mf70_face_full_instance_overlay.png"
    mask.save(mask_path)
    ...
    request = {
        "request_id": "wave70_mf70_face_full_instance_local_support",
        ...
        "mask_layers": [
            {
                ...
                "person_instance_id": "person_001",
                "body_region_id": "full_face_identity_region",
                "source": "deterministic_wave70_local_artifact",
                "routing_intent": "edit_or_protect_identity_region",
                "protected_regions": ["hairline", "neck", "ears", "background", "clothing"],
    ...
    contract = {
        ...
        "wave70_taxonomy": {
            ...
            "body_part": "face",
            "subregion": "full_face_identity_region",
        ...
        writer.writerow(
            {
                ...
                "pass_id": "wave70_mf70_face_full_instance_local_support",
                "output_prefix": "codex_wave70_mf70_face_full_instance",
            }
        )
    ...
    quality_report = {
        ...
        "protected_neighbor_check": {
            ...
            "protected_regions": ["hairline", "neck", "ears", "background", "clothing"],
            "notes": [
                "Mask covers the central visible face oval from lower forehead through chin and cheeks.",
                "Mask intentionally avoids broad hair volume, ears, neck, shirt collar, blazer, and background.",
    ...
    runtime_evidence = {
        "schema_version": "1.0",
        "evidence_id": f"W70-MF70-FACE-FULL-INSTANCE-RUNTIME-EVIDENCE-{RUN_STAMP}",
    ...
    qa_evidence = {
        "schema_version": "1.0",
        "evidence_id": f"W70-MF70-FACE-FULL-INSTANCE-LOCAL-SUPPORT-{RUN_STAMP}",
        "timestamp": "2026-07-07T14:55:00-05:00",
        "project_root": str(root),
        ...
        "result": RESULT,
        "boundary": "This proves local Wave70 mf70_face_full_instance mask artifact, overlay, quality score, and workflow routing support only. It does not mark the item complete because generated-output proof and target-runtime proof remain required.",
    }
    write_json(qa_path, qa_evidence)

    tracker_evidence = {
        "schema_version": "1.0",
        "tracker_evidence_id": f"W70_MF70_FACE_FULL_INSTANCE_LOCAL_MASK_SUPPORT_{RUN_STAMP}",
        ...
        "actual_work_performed": [
            "Generated deterministic local full-face identity-region mask PNG.",
