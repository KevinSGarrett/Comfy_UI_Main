...
CONTACT_STAMP = "20260708T181125-0500"
GATE_STAMP = "20260708T181125-0500"
TRACKER_ID = "TRK-W70-0171"
ITEM_ID = "ITEM-W70-0171"
NEXT_TRACKER_ID = "TRK-W70-0172"
NEXT_ITEM_ID = "ITEM-W70-0172"

STATUS_DECISION = "ref_images_1_2_contact_actor_references_available_route_not_complete_global_gates_pass"
COVERAGE_TOKENS = [
    ...
    "post_contact_occlusion_ref_images_1_2_geometry_gate_pass",
    "post_contact_occlusion_ref_images_1_2_promotion_gate_pass",
]

QA_GEOMETRY_GATE = f"Plan/Instructions/QA/Evidence/Mask_Factory/Wave70/W70_MASK_GEOMETRY_HARD_GATE_POST_CONTACT_OCCLUSION_REF_IMAGES_1_2_{GATE_STAMP}.json"
QA_PROMOTION_GATE = f"Plan/Instructions/QA/Evidence/Mask_Factory/Wave70/W70_MASK_PROMOTION_HARD_GATE_POST_CONTACT_OCCLUSION_REF_IMAGES_1_2_{GATE_STAMP}.json"
TRACKER_GEOMETRY_GATE = f"Plan/Tracker/Evidence/W70_MASK_GEOMETRY_HARD_GATE_POST_CONTACT_OCCLUSION_REF_IMAGES_1_2_{GATE_STAMP}.json"
TRACKER_PROMOTION_GATE = f"Plan/Tracker/Evidence/W70_MASK_PROMOTION_HARD_GATE_POST_CONTACT_OCCLUSION_REF_IMAGES_1_2_{GATE_STAMP}.json"
...
HYDRATION_FILES = {
    "CURRENT_SESSION_STATE.md": "Session State Update - 0171 Ref Images 1 2 Contact Occlusion Gates Passed",
    "CURRENT_PURSUING_GOAL.md": "Current Pursuing Goal Update - 0171 Ref Images 1 2 Contact Occlusion Gates Passed",
    "RESUME_HERE_NEXT_CODEX_SESSION.md": "Resume Update - 0171 Ref Images 1 2 Contact Occlusion Gates Passed",
    "NEXT_ACTION.md": "Immediate Next Action - Ref Images 1 2 - Re-evaluate TRK-W70-0172 Body Region Geometry",
    "QA_EVIDENCE_INDEX.md": "Wave70 0171 Ref Images 1 2 Contact Occlusion Gate Evidence",
}
...
def update_csv(path: Path, key: str, target: str) -> int:
    ...
    note = (
        "Contact/occlusion ownership authority 20260708T181125-0500: reran with Ref_Image_1 plus Ref_Image_2 combined body matrix. "
        "Combined context records 9 full/near-full references and 78 gold masks, including hand/finger, foot/support, and body-surface actors. "
...
def hydration_block(name: str) -> str:
    ...
    if name == "NEXT_ACTION.md":
        tail = f"Next exact local action: re-evaluate `{NEXT_TRACKER_ID}` / `{NEXT_ITEM_ID}` body region geometry resolver using Ref_Image_1+Ref_Image_2 combined references."
...
Re-ran `{TRACKER_ID}` / `{ITEM_ID}` contact/occlusion ownership authority with Ref_Image_1 plus Ref_Image_2 combined body-reference context.
...
def append_proof_log() -> None:
    row = [
        ISO_TS,
        "70",
        "Wave70 0171 Ref_Image_1+2 contact occlusion rerun and gates passed",
        "Reran TRK/ITEM-W70-0171 with combined Ref_Image_1 and Ref_Image_2 body reference context; attached gates and kept no-promotion Required_Not_Complete state.",
        "; ".join(EVIDENCE_PATHS),
        "python py_compile; implement_wave70_contact_occlusion_ownership_authority.py; Test-Wave70MaskGeometryGate.ps1; Test-Wave70MaskPromotionGate.ps1; CSV row verification",
        "REF_IMAGES_1_2_CONTACT_OCCLUSION_REFERENCE_AVAILABLE_ROUTE_NOT_COMPLETE_GATES_PASS",
        f"Plan/Instructions/QA/Evidence/Mask_Factory/Wave70/W70_CONTACT_OCCLUSION_OWNERSHIP_AUTHORITY_{CONTACT_STAMP}.json",
        f"Continue Wave70 at {NEXT_TRACKER_ID} / {NEXT_ITEM_ID} body region geometry resolver with combined body references.",
    ]
