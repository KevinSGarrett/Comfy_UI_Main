#!/usr/bin/env python3
"""Validate the Qwen3-ASR isolated Python environment admission and lock."""
...
LOCK_SHA256 = "241dfaab72cea25fe705693ef715e8368d171720ae3dc37e1c17ecc81b18ba22"
...
def validate(admission: dict, lock: dict, lock_path: Path) -> list[str]:
    ...
    if len(packages) != 105 or resolution.get("package_count") != 105:
    ...
    if wheel_count != 109 or resolution.get("wheel_count") != 109:
...
def main() -> int:
    ...
    if errors:
        for error in errors:
            print(f"ERROR: {error}")
        return 1
    print("W64_AQA_PYTHON_ENVIRONMENT_ADMISSION_VALID")
    return 0
