...
SOFT_STAMP = "20260708T182326-0500"
GATE_STAMP = "20260708T182326-0500"
TRACKER_ID = "TRK-W70-0174"
ITEM_ID = "ITEM-W70-0174"
NEXT_TRACKER_ID = "TRK-W70-0175"
NEXT_ITEM_ID = "ITEM-W70-0175"

STATUS_DECISION = "ref_images_1_2_soft_body_anchor_references_available_route_not_complete_global_gates_pass"
COVERAGE_TOKENS = [
    ...
    "post_soft_body_ref_images_1_2_geometry_gate_pass",
    "post_soft_body_ref_images_1_2_promotion_gate_pass",
]

QA_GEOMETRY_GATE = f"Plan/Instructions/QA/Evidence/Mask_Factory/Wave70/W70_MASK_GEOMETRY_HARD_GATE_POST_SOFT_BODY_REF_IMAGES_1_2_{GATE_STAMP}.json"
QA_PROMOTION_GATE = f"Plan/Instructions/QA/Evidence/Mask_Factory/Wave70/W70_MASK_PROMOTION_HARD_GATE_POST_SOFT_BODY_REF_IMAGES_1_2_{GATE_STAMP}.json"
TRACKER_GEOMETRY_GATE = f"Plan/Tracker/Evidence/W70_MASK_GEOMETRY_HARD_GATE_POST_SOFT_BODY_REF_IMAGES_1_2_{GATE_STAMP}.json"
TRACKER_PROMOTION_GATE = f"Plan/Tracker/Evidence/W70_MASK_PROMOTION_HARD_GATE_POST_SOFT_BODY_REF_IMAGES_1_2_{GATE_STAMP}.json"

EVIDENCE_PATHS = [
    f"Plan/Instructions/QA/Evidence/Mask_Factory/Wave70/W70_SOFT_BODY_ANCHOR_GEOMETRY_AUTHORITY_{SOFT_STAMP}.json",
    "Plan/Instructions/QA/Evidence/Mask_Factory/Wave70/soft_body_anchor_geometry_authority.json",
    f"Plan/Tracker/Evidence/W70_SOFT_BODY_ANCHOR_GEOMETRY_AUTHORITY_{SOFT_STAMP}.json",
    "Plan/Tracker/Evidence/soft_body_anchor_geometry_authority.json",
    f"runtime_artifacts/mask_factory/wave70_soft_body_anchor_geometry_authority/{SOFT_STAMP}/soft_body_anchor_geometry_authority.json",
    f"runtime_artifacts/mask_factory/wave70_soft_body_anchor_geometry_authority/{SOFT_STAMP}/soft_body_anchor_geometry_authority_reference_route_panel.png",
...
HYDRATION_FILES = {
    "CURRENT_SESSION_STATE.md": "Session State Update - 0174 Ref Images 1 2 Soft-Body Gates Passed",
    "CURRENT_PURSUING_GOAL.md": "Current Pursuing Goal Update - 0174 Ref Images 1 2 Soft-Body Gates Passed",
    "RESUME_HERE_NEXT_CODEX_SESSION.md": "Resume Update - 0174 Ref Images 1 2 Soft-Body Gates Passed",
    "NEXT_ACTION.md": "Immediate Next Action - Ref Images 1 2 - Work TRK-W70-0175 Temporal Body-Part Tracking",
    "QA_EVIDENCE_INDEX.md": "Wave70 0174 Ref Images 1 2 Soft-Body Gate Evidence",
}
...
def update_csv(path: Path, key: str, target: str) -> int:
    ...
    note = (
        "Soft-body anchor geometry authority 20260708T182326-0500: reran with Ref_Image_1 plus Ref_Image_2 combined body matrix. "
...
def hydration_block(name: str) -> str:
    ...
    if name == "NEXT_ACTION.md":
        tail = f"Next exact local action: work `{NEXT_TRACKER_ID}` / `{NEXT_ITEM_ID}` temporal body-part tracking and video mask drift authority using Ref_Image_1+Ref_Image_2 combined references."
...
Re-ran `{TRACKER_ID}` / `{ITEM_ID}` soft-body protected anchor geometry authority with Ref_Image_1 plus Ref_Image_2 combined body-reference context.
...
def append_proof_log() -> None:
    row = [
        ISO_TS,
        "70",
        "Wave70 0174 Ref_Image_1+2 soft-body gates passed",
        "Attached Ref_Image_1+2 soft-body evidence and gates; kept no-promotion Required_Not_Complete state.",
        "; ".join(EVIDENCE_PATHS),
        "python py_compile; implement_wave70_soft_body_anchor_geometry_authority.py; Test-Wave70MaskGeometryGate.ps1; Test-Wave70MaskPromotionGate.ps1; CSV row verification",
        "REF_IMAGES_1_2_SOFT_BODY_ROUTE_NOT_COMPLETE_GATES_PASS",
        f"Plan/Instructions/QA/Evidence/Mask_Factory/Wave70/W70_SOFT_BODY_ANCHOR_GEOMETRY_AUTHORITY_{SOFT_STAMP}.json",
