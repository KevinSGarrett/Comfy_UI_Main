...
OFFICIAL_ASSETS = [
    ...
    hf("mit_ast_audioset_0_4593", "audioset_527_class_audio_event_classification", "MIT/ast-finetuned-audioset-10-10-0.4593", "f826b80d28226b62986cc218e5cec390b1096902", "bsd-3-clause", False, "P0", [118, 128, 141, 142, 147], [("model.safetensors", 346404948, "ae0c1e2ad4e1381d851fa9bf298ba13ebc9c5a914cdee2dbe427a6583869924d")], "installed_storage_only_runtime_qualification_pending"),
...
ROW_BINDINGS = {
    ...
    "TRK-W64-128": ["hunyuanvideo_foley_xl", "stable_audio_3_small_sfx", "stable_audio_3_medium", "laion_clap_general", "mit_ast_audioset_0_4593"],
    ...
    "TRK-W64-141": ["whisper_large_v3_turbo", "laion_clap_general", "laion_clap_music_speech", "mit_ast_audioset_0_4593", "pyannote_diarization_community_1", "emotion2vec_plus_large"],
    "TRK-W64-142": [asset["asset_id"] for asset in OFFICIAL_ASSETS if "TRK-W64-142" in asset["required_by_rows"]],
...
def main(root: Path = ROOT) -> dict[str, Any]:
    ...
    catalog = {
        ...
        "status": "provider_resolved_candidates_mixed_storage_runtime_states_not_production_ready",
        "authority": {
        ...
        "deferred_or_exact_blocked": [
            {"asset_id": "beats_official_audioset_checkpoint", "status": "official_onedrive_http_403_exact_checkpoint_still_blocked", "reason": "Do not substitute an unverified community mirror; MIT AST is the separately admitted event-classification fallback, not BEATs equivalence."},
