# SDXL / RealVisXL compatibility template

This directory is a placeholder contract for the `sdxl_realvisxl_base_lane` base generation workflow template.
