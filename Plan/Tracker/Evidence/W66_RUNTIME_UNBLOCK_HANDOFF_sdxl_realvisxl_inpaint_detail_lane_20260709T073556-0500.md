...
- created_at: 2026-07-09T07:35:56-05:00
- result: handoff_git_checkpoint_blocked
- failure_category: local_git_worktree_dirty
- next_required_action: checkpoint_worktree_clean_to_origin_main
...
- Lane readiness: ready_for_ec2_static_proof, lane_id=sdxl_realvisxl_inpaint_detail_lane, lane_match=True, local_pre_ec2_ready=True, ready_for_ec2_static_proof=True, ready_for_generation=False
- Project readiness: pass_local_ready_runtime_blocked, lane_id=sdxl_realvisxl_inpaint_detail_lane, lane_match=True, local_ready=True, ec2_start_allowed=False, generation_allowed=False, scan_hit_count=0
...
- Git checkpoint gate: blocked_git_checkpoint_dirty_worktree, clean_worktree=False, local_matches_origin=True, porcelain_count=1268, passes_for_ec2_execute=False
