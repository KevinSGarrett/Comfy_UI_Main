...
- created_at: 2026-07-09T11:08:27-05:00
...
- exact_blockers: deploy_bundle_source_git_dirty_rebuild_required_before_ec2, explicit_user_target_runtime_selection_required, git_checkpoint_gate_not_clean_for_ec2_execute, input_assets_not_yet_published_to_s3_for_selected_lane, ec2_input_asset_install_execute_requires_explicit_intent
...
When live gates are later selected and clean, publish the listed source/mask assets to the recorded S3 URIs, run dry-run install plans, then run Install-EC2InputAssetFromS3.ps1 -Execute for each asset before bounded workflow smoke.
