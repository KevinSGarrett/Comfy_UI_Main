...
- created_at: 2026-07-09T04:09:01-05:00
...
- Lane readiness: ready_for_generation, lane_id=sdxl_low_risk_fallback_lane, lane_match=True, local_pre_ec2_ready=True, ready_for_ec2_static_proof=True, ready_for_generation=True
...
- Runtime lane queue: pass_local_only, first_runtime_lane_id=sdxl_low_risk_fallback_lane, current_runtime_lane_id=none_all_current_local_runtime_proofs_complete, current_runtime_lane_match=False, queue_complete_sentinel=True, selected_lane_order=1, queue_allows_selected_lane_ec2_static_proof=True
...
- Git checkpoint gate: blocked_git_checkpoint_dirty_worktree, clean_worktree=False, local_matches_origin=True, porcelain_count=1144, passes_for_ec2_execute=False
- Workflow smoke: workflow_smoke_generation_complete, run_id=aws_gpu_workflow_smoke_20260706T110424-0500, complete=True, final_state=stopped, local_pullback_status=s3_bucket_not_configured
...
- Image QA visual: pass_with_notes_for_runtime_smoke, qa_score=86, pass_threshold=80, complete=True
...
- Do not start EC2 unless runtime lane queue validation reports `current_runtime_lane_id=sdxl_low_risk_fallback_lane or current_runtime_lane_id=none_all_current_local_runtime_proofs_complete`, selected lane in queue, and failed check count `0`.
...
```powershell
powershell -ExecutionPolicy Bypass -File C:\Comfy_UI_Main\tools\Test-LocalComfyUIDevPreflight.ps1 -ProjectRoot C:\Comfy_UI_Main -LaneId sdxl_low_risk_fallback_lane -LocalComfyRoot <path-to-local-ComfyUI>
```
...
```powershell
powershell -ExecutionPolicy Bypass -File C:\Comfy_UI_Main\tools\New-EC2DeployBundle.ps1 -ProjectRoot C:\Comfy_UI_Main -LaneId sdxl_low_risk_fallback_lane -RunPackageManifestFile <run-package-manifest>
```
