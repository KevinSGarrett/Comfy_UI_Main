...
- created_at: 2026-07-09T03:45:33-05:00
...
- Runtime lane queue: pass_local_only, first_runtime_lane_id=sdxl_low_risk_fallback_lane, current_runtime_lane_id=none_all_current_local_runtime_proofs_complete, current_runtime_lane_match=False, selected_lane_order=1, queue_allows_selected_lane_ec2_static_proof=False
...
- Do not start EC2 unless runtime lane queue validation reports `current_runtime_lane_id=sdxl_low_risk_fallback_lane`, selected lane in queue, and failed check count `0`.
...
Expected evidence: result=pass_local_only, current_runtime_lane_id=sdxl_low_risk_fallback_lane, selected lane in queue, failed_check_count=0.
